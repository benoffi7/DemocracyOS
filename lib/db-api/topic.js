...
exports.all = function all(params, fn) {
  ...
  Topic
  .find(query)
  .select('id topicId mediaTitle tag projecttype participants votes createdAt updatedAt closingAt publishedAt deletedAt status open closed links author forum clauses')
