...
exports.getProfile = function getProfile(id, fn) {
  log('Looking for User Profile %s', id);
...
exports.expose.confidential = function(user){
  return expose('id firstName lastName displayName email avatar staff notifications locale web facebook twitter linkedin googlePlus youtube')(user);
}
